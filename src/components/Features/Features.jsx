  ...
  return (
    <>
      ...
      <StyledList>
        ...
        <li><SpeedIcon /> <H4>Bliksem snel</H4><P>Tegenwoordig lijkt iedereen minder tijd of geduld te hebben.</P><P>Hierdoor verwachten we snelle websites. Een snellere website wordt daarbij ook beter beloond door bijvoorbeeld Google met een hogere ranking in de zoekresultaten.</P></li>
